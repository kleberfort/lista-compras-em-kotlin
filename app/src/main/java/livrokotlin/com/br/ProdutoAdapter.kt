...
import livrokotlin.com.br.Utils.Companion.produtosGlobal
import java.text.NumberFormat
import java.util.Locale

class ProdutoAdapter(contexto: Context, private val produtos: List<Produto>) : ArrayAdapter<Produto>(contexto, 0, produtos) {
